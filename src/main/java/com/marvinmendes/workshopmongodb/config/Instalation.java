...
public class Instalation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO commentOne = new CommentDTO("Cool cool cool cool", sdf.parse("21/08/2020"), new AuthorDTO(carlos));
        CommentDTO commentTwo = new CommentDTO("(ツ)╭∩╮", sdf.parse("21/08/2020"), new AuthorDTO(fernando));

        postOne.getComments().add(commentOne);
        postTwo.getComments().add(commentTwo);
